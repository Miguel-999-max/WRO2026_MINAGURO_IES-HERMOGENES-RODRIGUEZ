...
<strong>01.Firmware of the Raspberry Pi Pico 2</strong>➜ First of all, you’ll need to install a firmware image on the Raspberry Pi Pico 2 so that we can load programmes onto it and use it in VScode. You can find the firmware on the official website <a href="https://micropython.org/download/RPI_PICO2/">MicroPython for Raspberry Pi Pico 2</a>, download it here. We’ll explain how to do this step by:
<br>
</br>
