...
import time
import hardware
from funciones_comunes import pulso_barrido, leer_tfmini, diferencia_angular, _comprobar_lineas
...
def esquivar_pilar(color_id):
    ...
    Devuelve siempre (None, None) - el llamador hace una busqueda normal
    para el siguiente pilar."""
    ...
    while True:
        ...
        # === TRAMO RECTO entre Fase 1 y Fase 2 (sin barrido) ===
