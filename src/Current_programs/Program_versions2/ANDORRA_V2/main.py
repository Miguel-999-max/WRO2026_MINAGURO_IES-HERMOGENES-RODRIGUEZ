...
#Hace perfectamente la decisión inicial y las misiones 1 y 2. La 3 solo desaparca. La 4 no hace nada.
...
import time
import hardware
from funciones_comunes import leer_tfmini, leer_tof_derecho_mm, clasificar_color
...
if distFR > 40:
    ...
    while not linea_detectada and hardware.sensor_color is not None:
        ...
        if claro < hardware.UMBRAL_BLANCO_A_COLOR:
            ...
            time.sleep_ms(10)
            r, g, b, claro = hardware.sensor_color.read_rgbc()
            color_final = clasificar_color(r, g, b)
