...
def navegar_calle_por_rumbo():
    ...
    El propio TFmini-S del barrido vigila la pared: si en la direccion hacia
    la que esta mirando ahora mismo mide menos de DISTANCIA_MINIMA_PARED_CM,
    frena (sin tocar la direccion, que sigue marcada por el rumbo) - antes
    forzaba el volante hacia el lado contrario, lo cual podia deshacer
    exactamente el giro que el rumbo estaba pidiendo y dejar al robot
    atascado entre las dos correcciones peleando entre si.
    ...
    while True:
        ...
        # angulo_oscilacion en este instante. Solo FRENA, nunca toca la
        # direccion - asi no contradice al rumbo, que es quien de verdad
        # sabe hacia donde hay que girar.
