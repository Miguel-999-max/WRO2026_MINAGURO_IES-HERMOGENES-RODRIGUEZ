...
def esquivar_pilar(color_id):
    ...
    while True:
        ...
        if distancia_actual is not None and distancia_actual <= hardware.DISTANCIA_RETROCESO_TRIGGER_CM \
        ...
        while time.ticks_diff(time.ticks_ms(), t0) < hardware.TIEMPO_ESQUIVE_MS:
            ...
            if distancia_frontal <= hardware.DISTANCIA_RETROCESO_TRIGGER_CM and intentos_retroceso < hardware.MAX_INTENTOS_RETROCESO:
