...
DISTANCIA_RETROCESO_OBJETIVO_CM = 18  # AJUSTAR EN PISTA: a esta distancia retrocede si empieza demasiado cerca
...
DISTANCIA_MINIMA_PARED_CM = 15  # AJUSTAR EN PISTA: si un lateral baja de esto navegando por rumbo, corrige alejandose de esa pared
