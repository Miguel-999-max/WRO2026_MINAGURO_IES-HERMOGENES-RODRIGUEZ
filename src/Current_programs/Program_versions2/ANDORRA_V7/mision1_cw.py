...
def ejecutar_mision_1_cw():
    ...
    print("Movimiento Inicial 2: Avanzando a la derecha pero menos...")
    hardware.servoDireccion.duty_u16(4700)
    hardware.servoTraccion.duty_u16(3800)
    time.sleep_ms(2200)

    print("Movimiento Inicial 3: Avanzando a la izquierda...")
    hardware.servoDireccion.duty_u16(5200)
    hardware.servoTraccion.duty_u16(3600)
    time.sleep_ms(1600)
    ...
    # === FASE 2: el MISMO sigue pared, ahora termina por TIEMPO (2200ms) ===
