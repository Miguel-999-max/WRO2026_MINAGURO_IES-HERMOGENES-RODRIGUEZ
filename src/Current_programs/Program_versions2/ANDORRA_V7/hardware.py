...
ANGULO_MAX_BARRIDO_CRUCERO = 90  # AJUSTAR EN PISTA: barrido oscilante propio de navegar_calle_por_rumbo (180 grados totales, limite fisico del servo)
...
ANGULO_BUSQUEDA_TRANSICION = 40  # AJUSTAR EN PISTA: barrido estrecho en el tramo entre fases de esquivar_pilar (grados a cada lado)
